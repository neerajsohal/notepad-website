...
<html lang="en">
	<head>
		...
		<link href="./statics/fancybox/jquery.fancybox.css" rel="stylesheet">
	...
	<body>
		...
		<div class="main">
			...
			<div class="container-fluid prepend-top">
				<div class="row-fluid">
					<div class="span6">
						<h4>Simple</h4>
						<p>Notepad is simple and easy to use. It's beautiful design let the things flow seamlessly</p>
						
					</div>
					<div class="span6">
						
						<h4>Beautiful</h4>
						<p>We have build this app keeping one thing in mind, beauty! It has clean typography which will not clutter the view and your notes not only will look beautiful but will also be reasy easy to read.</p>
					</div>
				</div>
				<div class="row-fluid">
					<div class="span12">
						...
						<p>Thats not all!</p>
						<ul>
							<li>Simple minimalist design. No clutter, no distracting colors.</li>
							<li>Includes all the features that a note taking app should and must have.</li>
							<li>Beautiful Typography.</li>
							<li>Supports Android 8+ ( Android 2.2.x and above )</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<script src="./statics/fancybox/jquery.fancybox.js"></script>
